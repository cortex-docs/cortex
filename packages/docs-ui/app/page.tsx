...
function CortexGrid() {
  return (
    <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>{`
          .cg-line { stroke: rgba(255,255,255,0.08); stroke-width: 0.5; stroke-dasharray: 2 3; }
          .cg-node { fill: rgba(255,255,255,0.02); }
          ...
          @keyframes cgLine { 0%,100% { stroke: rgba(255,255,255,0.08); } 50% { stroke: rgba(255,255,255,0.18); } }
          @keyframes cgNode { 0%,100% { fill: rgba(255,255,255,0.02); } 50% { fill: rgba(255,255,255,0.07); } }
        `}</style>
      </defs>
      ...
      <main className="flex-1">
        <div className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-20">
            ...
            <div
              className={`grid gap-6 sm:grid-cols-2 ${sections.length >= 3 ? 'lg:grid-cols-3' : ''}`}
            >
              {sections.map((section, idx) => {
                ...
                return (
                  <Link
                    key={section.title}
                    href={section.href}
                    className="group relative glass-card glass-card-hover rounded-xl overflow-hidden transition-all duration-700 ease-out hover:-translate-y-px hover:border-primary/25"
                  >
                    <div className="relative h-32 bg-black overflow-hidden">
                      <div
                        className="absolute inset-0"
                        style={{ backgroundColor: 'var(--primary-card-tint)', opacity: 0.06 }}
                      />
                      <div
                        className="absolute inset-0"
                        style={{
                          background:
                            'radial-gradient(ellipse 70% 80% at 50% 50%, var(--primary-card-tint), transparent 70%)',
                          opacity: 0.1,
                        }}
                      />
                      <div
                        ...
                        <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                          <div className="relative flex items-center justify-center">
                            <div
                              ...
                              style={{
                                background:
                                  'radial-gradient(circle, var(--primary-card-tint), transparent 70%)',
                                opacity: 0.08,
                              }}
                            />
